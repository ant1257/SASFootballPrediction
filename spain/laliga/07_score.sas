...
ods excel
	file = "/folders/myfolders/footbal/spain/laliga/excel/pred_esp_lal_&season._&round..xlsx"
...
proc export data = data_f.tlg_bot_&season._&round
	outfile = "/folders/myfolders/footbal/spain/laliga/excel/esp_lal_tlg_bot_&season._&round..xlsx"
	dbms = xlsx
	replace;
run;
