...
%macro get_dm(from = 1979, to = 2020);
...
/*   outfile = '/folders/myfolders/footbal/germany/bundesliga1/csv/train.csv' */
/*   dbms = csv */
/*   replace; */
/* run; */
/*  */
/* proc export data = data_f.test */
/*   outfile = '/folders/myfolders/footbal/germany/bundesliga1/csv/test.csv' */
/*   dbms = csv */
/*   replace; */
/* run; */
