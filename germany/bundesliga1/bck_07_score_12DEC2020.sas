	...
	data &data._&target;
		set &data._&target;
			...
			%else %if &target = x1 %then %do;
				if cluster = 1 then do;
					if p_1 < 0.7 then segment = 'RED';
					else if p_1 < 0.77 then segment = 'GRAY';
					else if p_1 < 0.86 then segment = 'YELLOW';
					else segment = 'BLUE';
				end;
				
				else if cluster = 2 then do;
					if p_1 < 0.72 then segment = 'RED';
					else if p_1 < 0.75 then segment = 'GRAY';
					else if p_1 < 0.85 then segment = 'YELLOW';
					else segment = 'BLUE';
				end;
				
				else if cluster = 3 then do;
					if p_1 < 0.71 then segment = 'RED';
					else if p_1 < 0.81 then segment = 'GRAY';
					else if p_1 < 0.85 then segment = 'YELLOW';
					else segment = 'BLUE';
				end;
					...
					else if p_1 < 0.83 then segment = 'YELLOW';
					else segment = 'BLUE';
				end;
			%end;
			...
			%else %if &target = x2 %then %do;
				if cluster = 1 then do;
					if p_1 < 0.49 then segment = 'RED';
					else if p_1 < 0.575 then segment = 'GRAY';
					else if p_1 < 0.64 then segment = 'YELLOW';
					else segment = 'BLUE';
				end;
					...
					if p_1 < 0.483 then segment = 'RED';
					else if p_1 < 0.569 then segment = 'GRAY';
					else if p_1 < 0.639 then segment = 'YELLOW';
					else segment = 'BLUE';
				end;
			%end;
...
ods excel
	file = "/folders/myfolders/footbal/germany/bundesliga1/excel/pred_ger_b1_&season._&round..xlsx"
...
proc export data = data_f.tlg_bot_&season._&round
	outfile = "/folders/myfolders/footbal/germany/bundesliga1/excel/ger_bl1_tlg_bot_&season._&round..xlsx"
	dbms = xlsx
	replace;
run;
