	...
	data &data._&target;
		set &data._&target;
			...
			%if &target = home_win %then %do;
				if p_1 < 0.4379747647 then segment = 'RED';
				else if p_1 < 0.6159179428 then segment = 'YELLOW';
				else segment = 'GREEN';
			%end;
			
			%else %do;
				if p_1 < 0.2166759789 then segment = 'RED';
				else if p_1 < 0.3666038153 then segment = 'YELLOW';
				else segment = 'GREEN';
			%end;
