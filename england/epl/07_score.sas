...
ods excel
	file = "/folders/myfolders/footbal/england/epl/excel/pred_eng_epl_&season._&round..xlsx"
...
proc export data = data_f.tlg_bot_&season._&round
	outfile = "/folders/myfolders/footbal/england/epl/excel/eng_epl_tlg_bot_&season._&round..xlsx"
	dbms = xlsx
	replace;
run;
