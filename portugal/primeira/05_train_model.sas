	...
	data &data._&target;
		set &data._&target;
			...
			%if &target = home_win %then %do;
				if p_1 < 0.4142068312 then segment = 'RED';
				else if p_1 < 0.6086123658 then segment = 'YELLOW';
				else segment = 'GREEN';
			%end;
			
			%else %do;
				if p_1 < 0.2241109958 then segment = 'RED';
				else if p_1 < 0.3988296089 then segment = 'YELLOW';
				else segment = 'GREEN';
			%end;
